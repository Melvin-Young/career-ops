...
ACTIONS:
- navigate {"path":"/pipeline?tab=OFFER&min=4"} — take the user to a section. Valid paths: /, /pipeline, /portals, /analytics, /evidence, /cv, /config, /apply, /pipeline/{n} (a role workspace), /jobs/{id} (a worker). The path may carry a query string.
